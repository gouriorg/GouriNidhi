-- Cashiers record the calendar date cash was received.

drop function if exists public.cashier_set_payment(uuid, uuid, uuid, boolean);
...
grant execute on function public.cashier_set_payment(uuid, uuid, uuid, boolean, date) to authenticated;
